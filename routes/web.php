...
Route::get('/run-migration', function () {
    ...
    return view('Migrations executed successfully'); 
});
...
Route::get('document/all', [DocumentController::class, 'create'])->name('document.create');
Route::get('document/register', [DocumentController::class, 'register'])->name('document.register');
Route::post('document/register', [DocumentController::class, 'registerUser'])->name('document.registerUser');
